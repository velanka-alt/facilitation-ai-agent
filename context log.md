...
- `docs/samples_guide.md`: 샘플 코퍼스 활용 가이드 추가
- `docs/review_checklist.md`: 리뷰 체크리스트 추가
...
- `mvp-usability-tuning`: MVP 추천 로직 개선 + 컨설팅 권고 규칙/Mode A 업데이트 + PR 가이드/템플릿 + 경계/문구/샘플/리뷰 가이드
